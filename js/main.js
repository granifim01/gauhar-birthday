...
2 октября — день, когда мир снова становится красивее, потому что в нём есть ты.

Ты — улыбка среди бугенвиллий, взгляд в очках вечером и сила в серебре традиций. Ты была Кенесбекова. 3 октября 2025 в Алматы ты стала Далабаевой. А для меня ты всегда — дом, жаным, золотце.

С днём рождения. Я люблю тебя. Безумно.`;

  const REASONS = [
    { title: "Твоя улыбка", text: "Она делает любой день светлее — даже если за окном Алматы серо." },
    { title: "Твои «люблю»", text: "Ты пишешь «люблю тебя сиииильно» — и я таю каждый раз." },
    { title: "Твоя забота", text: "«Покушай жаным», «вылечи горло» — ты любишь делами, не только словами." },
    { title: "Твоя сила", text: "Ты умеешь держать мир — и всё равно остаёшься нежной." },
    { title: "Твой стиль", text: "Шляпа, очки, украшения, студия — ты всегда выглядишь как история." },
    { title: "Мы", text: "Потому что с 3 октября 2025 «мы» — уже официально. И навсегда." },
  ];

  const QUIZ = [
    {
      q: "Как я чаще всего тебя называю?",
      options: ["Золотце", "Товарищ майор", "Соседка", "Босc"],
      correct: 0,
      ok: "Да. Моё золотце.",
      bad: "Почти… но сердце знает ответ.",
    },
    {
      q: "Когда у нас роспись в РАГСе?",
      options: ["3 октября 2025", "1 января", "Когда-нибудь потом", "Уже забыли"],
      correct: 0,
      ok: "Именно. Медеуский РАГС, 11:00 — наш день.",
      bad: "Подсказка: осень, Алматы, Конаева 108.",
    },
    {
      q: "Когда твой день рождения?",
      options: ["2 октября", "31 декабря", "8 марта", "Когда угодно"],
      correct: 0,
      ok: "Правильно. Поэтому этот сайт — для тебя.",
      bad: "Эх… попробуй ещё раз сердцем.",
    },
    {
      q: "Сколько раз я могу сказать «я тебя люблю»?",
      options: ["Бесконечно", "Раз в год", "Только в Telegram", "Никогда"],
      correct: 0,

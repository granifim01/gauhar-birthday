...
Люблю тебя сиииильно.`;
  ...
  const STORIES = [
    {
      ...
      text: "11 июля мы просто перешли в Telegram — «наконец-то нормальный мессенджер». А уже на следующий день: «куда бы хотела сходить?» Так началось всё, что потом стало домом.",
    },
    {
    ...
    },
    {
      ...
      text: "5 августа ты услышала от меня «спокойной ночи, золотце». С тех пор это слово живёт в чате, как тёплая лампа у кровати.",
    },
    {
      when: "октябрь 2024",
      title: "Первое «жаным»",
  ...
  const CHIPS = [
    { word: "жаным", mean: "260+ раз в чате. Когда ты зовёшь меня так — я уже дома." },
    { word: "золотце", mean: "Моё имя для тебя перед сном. Мягкое, как свет в комнате." },
    { word: "ути", mean: "Маленькое слово, после которого всё становится теплее. Сотни раз." },
    { word: "сиииильно", mean: "Твоя фирменная громкость любви. Чем больше «и» — тем роднее." },
    { word: "солнце", mean: "Ещё одно твоё имя для меня. Светит даже в переписке." },
    { word: "зай", mean: "Коротко, мило и только наше." },
    { word: "спасииибо", mean: "Спасибо с лишними «и» — значит, правда от сердца." },
    { word: "дааа", mean: "Самое частое согласие в нашем чате. Иногда с четырьмя «а»." },
    { word: "хорошооо", mean: "Когда всё ок — но хочется протянуть гласные, как объятие." },
    { word: "ураааа", mean: "Наша маленькая салютная пушка в сообщениях." },
  ];
  ...
  const MOMENTS = [
    ...
    { src: "assets/videos/range.mp4", poster: "assets/videos/range.jpg", cap: "Меткая" },
    { src: "assets/videos/cape-scooter.mp4", poster: "assets/videos/cape-scooter.jpg", cap: "Плащ и самокат" },
    { src: "assets/videos/gift-box.mp4", poster: "assets/videos/gift-box.jpg", cap: "Сюрприз" },
  ];

  const RITUALS = [
    { ico: "🌙", title: "Спокойной ночи", text: "Почти 300 раз в чате. Иногда с сердцем. Иногда с «золотце». Всегда — как обещание дождаться утра." },
    ...
    { ico: "🐱", title: "Дошка ≈ почти я", text: "«Дошку обнимала думала что это ты». Комплимент, который нельзя купить." },
  ];
  ...
  const STARS = [
    ...
    "В берете ты — кино",
    "В шляпе ты — лето",
    "Ты красивая без повода",
    "Рядом с тобой я дома",
    "Твои «сиииильно» лечат",
    "Даже в хаосе ты — мой покой",
    "Я горжусь тобой",
    "С тобой хочется завтра",
    "Ты мой человек",
    "Я выбираю тебя снова",
    "Наш чат — тоже объятие",
  ];
